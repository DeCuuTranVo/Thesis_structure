...
dict_x_train = load(os.path.join(root_numpy_array, "x_val.npz"))
x_train = dict_x_train['arr_0']
print(x_train.shape)

# dict_x_train_0 = load(os.path.join(root_numpy_array, "x_train_subset_182218182_0.npz"))
# x_train_0 = dict_x_train_0['arr_0']
# print(x_train_0.shape)

# print(np.array_equal(x_train, x_train_0))

# dict_x_train = load(os.path.join(base_path, "data",  'data_numpy_array', 'x_train_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH) +'.npz'))
# dict_x_val = load(os.path.join(base_path, "data",  'data_numpy_array', 'x_val_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH) +'.npz'))
# dict_x_test = load(os.path.join(base_path, "data",   'data_numpy_array', 'x_test_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH)  +'.npz'))
# dict_y_train = load(os.path.join(base_path, "data",  'data_numpy_array', 'y_train_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH)  +'.npz'))
# dict_y_val = load(os.path.join(base_path, "data",   'data_numpy_array', 'y_val_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH) +'.npz'))
# dict_y_test = load(os.path.join(base_path, "data",   'data_numpy_array', 'y_test_' + "subset_" + str(TARGET_WIDTH) + str(TARGET_HEIGHT) + str(TARGET_DEPTH) +'.npz'))
